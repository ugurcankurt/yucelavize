      ...
      <div className="bg-secondary/20">
        ...
        <div className="container mx-auto px-4 pb-6 flex flex-col-reverse md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-4 items-center">
            <a href="https://instagram.com/yucelavizecom" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-border/80 flex items-center justify-center text-foreground hover:bg-foreground hover:text-background transition-all duration-300 bg-background" aria-label="Instagram">
            ...
            <a href="https://facebook.com/yucelavize" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-border/80 flex items-center justify-center text-foreground hover:bg-foreground hover:text-background transition-all duration-300 bg-background" aria-label="Facebook">
