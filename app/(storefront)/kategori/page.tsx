...
export const metadata: Metadata = {
  ...
  description: "Yücel Avize'deki tüm aydınlatma ve aksesuar kategorilerini keşfedin.",
};
  ...
  return (
    <div className="w-full">
      ...
      <PageHero
        ...
        description="Evinizin her köşesi için özenle tasarlanmış aydınlatma ve aksesuar kategorilerimizi keşfedin."
        breadcrumbs={[{ label: "Tüm Kategoriler" }]}
      />
      ...
      <div className="container mx-auto px-4 py-12">
        {!categories || categories.length === 0 ? (
          <div className="text-center py-20 bg-muted/20 rounded-3xl border border-border/50">
            ...
            <h2 className="text-xl font-bold text-foreground mb-2">Kategori Bulunamadı</h2>
            <p className="text-muted-foreground">Henüz eklenmiş bir kategori bulunmuyor.</p>
          </div>
        ) : (
