...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.yucelavize.com/kategori/${resolvedParams.slug}/${resolvedParams.productSlug}`,
    },
  };
}
export default async function ProductDetailPage({
  ...
  const jsonLd = {
    ...
    offers: {
      "@type": "Offer",
      url: `https://www.yucelavize.com/kategori/${resolvedParams.slug}/${product.slug}`,
      priceCurrency: "TRY",
      price: finalPrice,
  ...
  const categoryName = product.category
    ...
    : "Aydınlatma";
  const categorySlug = Array.isArray(product.category) ? product.category[0]?.slug : product.category?.slug;
  return (
    <>
      ...
      <BreadcrumbJsonLd 
        items={[
          ...
          ...(categorySlug ? [{ name: categoryName, url: `https://www.yucelavize.com/kategori/${categorySlug}` }] : []),
          { name: product.name, url: `https://www.yucelavize.com/kategori/${resolvedParams.slug}/${product.slug}` }
        ]}
      />
      {" "}
      <script
